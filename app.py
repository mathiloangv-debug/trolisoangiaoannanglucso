...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Loàn - Trường Tiểu học Minh Quang - ĐT: 0329 7552 99</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thi Loàn - Trường Tiểu học Minh Quang - ĐT: 0329 7552 99</div>", unsafe_allow_html=True)
